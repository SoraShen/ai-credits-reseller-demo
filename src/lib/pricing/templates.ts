...
export const PARAMS_A: PricingParams = {
  ...
  minDiscount: 0.72,
  promoDiscount: 0.85,
  promoStacksOnAnnual: false,
  promoEndsAt: PROMO_END,
  promoLabelEn: "Limited-time Early Bird: 15% Off monthly plans",
  promoLabelZh: "限时早鸟价：月付套餐 85 折",
};
...
export const PARAMS_B: PricingParams = {
  ...
  promoDiscount: 0.85,
  promoStacksOnAnnual: false,
  promoLabelEn: "Launch Offer: 15% Off monthly + aggressive entry pricing",
  promoLabelZh: "上线特惠：月付 85 折 + 激进入门价",
};
